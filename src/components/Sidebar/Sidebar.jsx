...
const Sidebar = ({ toggle, state, setState }) => {
  ...
  const assignedModules =
    JSON.parse(localStorage.getItem("userData"))?.service || [];
        ...
        <Menu>
          ...
          <span>
            <h5
              ...
              style={{ color: "blue", fontSize: "15px", fontWeight: "600" }}
            >
              Welcome {getdataformLocal.fullName}
            </h5>{" "}
          </span>
          ...
          {assignedModules.includes("Ghee Collection") && (
            <SubMenu label="Ghee">
              <MenuItem
                onClick={() => {
                  navigate("/gheeentry");
