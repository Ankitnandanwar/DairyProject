...
const ProductSale = () => {
    ...
    const handleSave = async () => {
        try {
            const cashTotalValue = productDetails.rate * saleCash;
            const onlineTotalValue = productDetails.rate * saleOnline;
            const totalAmtValue = cashTotalValue + onlineTotalValue;
            const openingBalanceValue = productDetails.openingBalance + addQty;
            const closingBalanceValue = openingBalanceValue - mix - paymentPending - waiveOff - saleCash - saleOnline;
            ...
            const res = await axios.post("http://103.38.50.113:8080/DairyApplication/saveProductAddSale", {
                ...
                saleCash,
                saleOnline,
                cashTotal: cashTotalValue,
                onlineTotal: onlineTotalValue,
                totalAmt: totalAmtValue,
