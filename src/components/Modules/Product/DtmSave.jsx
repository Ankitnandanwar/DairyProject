...
const DtmSave = () => {
    ...
    const [firstTableAdd, setfirstTableAdd] = useState([{ Hosteldropdown: "", qtyInput: "" }])
    const [secondTableAdd, setSecondTableAdd] = useState([{ StdHosteldropdown: "", standQty: "" }])
    ...
    const addSecondRow = () => {
        setSecondTableAdd([...secondTableAdd, { StdHosteldropdown: "", standQty: "" }])
    }
    ...
    useEffect(() => {
        ...
        const fetchHostels = async () => {
            try {
                const response = await axios.get('http://103.38.50.113:8080/DairyApplication/getHostel');
    ...
    const CalculateTotals = () => {
        ...
        const dtmAmountOnline =
            parseInt(dtmMilkRate) * parseInt(dtmsaleOnline);
    ...
    const saveData = async () =>{
        try {
            const resp = await axios.post("http://103.38.50.113:8080/DairyApplication/saveDtmMilkSales", {
                openingBalance,
                closingBalance,
                product,
                    ...
                    <div className="col-12 col-lg-6 col-xl-3 col-md-6 d-flex justify-content-center align-items-center">
                        ...
                        >
                            <TextField label="Rate"
                                variant="standard" value={dtmMilkRate} />
                        </Box>
                    </div>
